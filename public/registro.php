...
$atleticas = $conexao->query("SELECT id, nome FROM atleticas ORDER BY nome");
    ...
    if ($tipo_usuario_detalhado != 'Comunidade Externa' && !in_array($email_domain, ['unifio.edu.br', 'fio.edu.br'])) {
        $erros[] = "Para este tipo de vínculo, é obrigatório o uso de um e-mail institucional UNIFIO.";
    }
